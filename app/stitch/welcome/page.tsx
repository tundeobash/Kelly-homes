...
export default function WelcomePage() {
  return (
    <div className="relative flex h-screen w-full flex-col overflow-hidden bg-background-light dark:bg-background-dark group/design-root">
      {/* STITCH PAGE MARKER - This is /stitch/welcome */}
      <div className="fixed top-4 right-4 z-50 bg-primary-green text-[#0e1b12] px-3 py-1.5 rounded-full text-xs font-bold shadow-lg">
        STITCH PAGE
      </div>
